 ...
 * @param root0.skills
 */
export default function AboutMe({ skills }: AboutMeProps) {
  return (
    <Section
      className={tw`relative flex h-fit min-h-full flex-col items-start justify-normal gap-y-10 bg-linear-to-b from-transparent to-blue-600/50 px-8 dark:from-slate-950/80 dark:to-blue-950/80 md:px-20`}
      id="about"
    >
      ...
      <p className={tw`w-full text-lg`}>
        ...
        ,
        {' '}
        <code className={tw`text-blue-600`}>Blue</code>
        ,
        <code className={tw`text-amber-500`}>Orange</code>
        , and
        {' '}
