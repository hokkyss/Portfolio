...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className={tw`pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,oklch(var(--foreground)/0.04)_1px,transparent_1px),linear-gradient(to_bottom,oklch(var(--foreground)/0.04)_1px,transparent_1px)] bg-size-[3rem_3rem]`}
      />
