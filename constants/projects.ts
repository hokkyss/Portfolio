...
export const projects: Project[] = [
  {
    ...
    preview: "/images/rubik-cube-solver.jpg",
    links: {
  ...
  },
  {
    ...
    preview: "/images/semi-github.jpg",
    links: {
  ...
  },
  {
    name: "OTOBOT",
    description:
      "A chatbot to save and display deadlines or times, such as date for final exam, or task deadline. Built using flask, socketio, and sqlite3. Do note that this chatbot communicates in Indonesian language.",
