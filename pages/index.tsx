...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>
          {underDevelopment ? "Under Development" : "Hokki Suwanda"}
        </title>
      </Head>
          ...
          <ContentContainer>
            ...
            <Section sectionRef={aboutRef} title="AboutMe">
              <NormalText>
                ...
                student in Bandung Institute of Technology. I&apos;m very
                passionate in modern technology, especially in Software
                Engineering fields.
              </NormalText>
              <NormalBreak />
              <NormalText>
                I&apos;m currently exploring Web Development. However, I&apos;m
                willing to learn other things too! And importantly, I&apos;m
                open to work!
              </NormalText>
              <BigBreak />
              <TechStacks />
